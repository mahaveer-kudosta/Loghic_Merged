...
const themeDark = createTheme({
  ...
  shadows: [
    ...
    "0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 3px 14px 2px rgba(0, 0, 0, 0.12), 0px 5px 5px -3px rgba(0, 0, 0, 0.14)",
    "0px 6px 6px -3px rgba(0, 0, 0, 0.2), 0px 3px 14px 2px rgba(0, 0, 0, 0.12), 0px 5px 5px -3px rgba(0, 0, 0, 0.14)",
    // ... more shadows
    "0px 20px 25px -5px rgba(0, 0, 0, 0.3), 0px 10px 10px -5px rgba(0, 0, 0, 0.14)",
  ],
  components: {
    MuiButton: {
      styleOverrides: {
        root: {
          ...
          boxShadow: "none",
          "&:hover": {
            boxShadow: "0px 7px 14px rgba(0, 0, 0, 0.4)",
          },
        },
        containedPrimary: {
